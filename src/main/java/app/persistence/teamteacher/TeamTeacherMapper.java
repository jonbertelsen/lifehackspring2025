package app.persistence.teamteacher;
...
public class TeamTeacherMapper {
    ...
    public static TeamTeacherQuote getPhilosophicalAnswer(String input, ConnectionPool connectionPool) {
        List<Integer> keywordIDs = getKeyWordIDs(input, connectionPool);
        if (keywordIDs.isEmpty()) {
            return new TeamTeacherQuote("Kierkegaard", "Af alle latterlige Ting forekommer det mig at være det allerlatterligste at have travlt", "kierkegaard.png");
        }
        ...
        try (Connection conn = connectionPool.getConnection();
            ...
            if (rs.next()) {
                return new TeamTeacherQuote(rs.getString("name"), rs.getString("quote"), rs.getString("picture"));
            }
